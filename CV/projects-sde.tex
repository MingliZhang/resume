...
%---------------------------------------------------------
  ...
  %   {North Carolina, USA} % Location
  %   {An open source state of the art key value store database developed by VMWare}
  %   {
  %     \begin{cvitems} % Description(s) of project
  %       \item {Worked closely with researchers from VMWare on SplinterDB, an \textbf{open source project}, and .}
  %       \item {Identified memory limitations in the existing implementation of SplinterDB, an \textbf{open source project}, }
  %       \item {Optimized SplinterDB's cache lookup table using \textbf{C} to support insufficient memory in extreme cases at the cost of 5\% slowdown.}
