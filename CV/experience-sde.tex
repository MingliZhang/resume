  ...
  \cventry
    ...
    {Oct 2021 - Feb 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        % \item {Created the personal dataset upload feature involving frontend support, NER, and elastic search indexing.}
        \item {Explored with researchers and developers on the team to replace the \textbf{K-Means} algorithm with \textbf{Hierarchical clustering}, which reduced redundant computation overhead by \textbf{70\%}.}
        ...
        \item {Refactored the codebase and transitioned from pure \textbf{HTML}, \textbf{CSS}, and \textbf{in-line JavaScript} to \textbf{Next.js}, which improved readability and reduced code redundancy by \textbf{30\%}}
